...
DEFAULT_DECODER_CHECKPOINT = Path(__file__).resolve().parents[2] / "checkpoints/hf/ss_decoder.ckpt"
...
def main():
    ...
    pointmap = depth_to_pointmap(np.load(depth_path, allow_pickle=False), K).astype(np.float64)
