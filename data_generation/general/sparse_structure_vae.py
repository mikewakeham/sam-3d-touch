...
# Copied from sam3d_objects/model/backbone/tdfy_dit/models/sparse_structure_vae.py.
# Only helper imports differ; checkpoint architecture is unchanged.
import os
import math
from typing import *
import torch
...
from vae_utils import (GroupNorm32, ChannelLayerNorm32, pixel_shuffle_3d,
