...
import zipfile
import numpy as np
from analyze_shared_orientation_geometry import analyze,aggregate as old_aggregate,same,witness
from statistics import mean
from orientation_coverage_protocol import rotations,rotate_grid,inverse_frame,schedule
...
def main():
    ...
    oldroot=HERE/'shared_orientation_visuals_analysis/bundle'
    ...
    validation=dict(arms=validations,matched_start_optimizer_exposure=True,all384_target_bank_geometries_reproduced=True,
        source_sha256={n:sha(HERE/n) for n in ('analyze_orientation_coverage.py','analyze_shared_orientation_geometry.py','pose_shape_geometry.py','orientation_coverage_protocol.py')},
