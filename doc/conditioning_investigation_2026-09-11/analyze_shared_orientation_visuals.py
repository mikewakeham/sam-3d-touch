...
import zipfile
import numpy as np
from analyze_shared_orientation_geometry import analyze,aggregate,same
...
def main():
    ...
    root=out/'bundle';oldroot=HERE/'shared_orientation_scope_analysis'
    ...
    validation=dict(bundle_sha256=sha(args.bundle),payload_members=144,rows=224,
        ...
        source_sha256={n:sha(HERE/n) for n in ('analyze_shared_orientation_visuals.py','analyze_shared_orientation_geometry.py','pose_shape_geometry.py')},
