...
from protocol import check_splits, evaluation_groups
...
def main():
    ...
    source_paths = [Path(__file__), HERE / 'checkpoint_probe_core.py', HERE / 'protocol.py',
                    REPO / 'train.py', REPO / 'evaluate.py', REPO / 'dataloader.py',
                    REPO / 'sam3d_objects/model/backbone/dit/embedder/touch.py',
                    REPO / 'sam3d_objects/model/backbone/generator/shortcut/model.py',
                    REPO / 'sam3d_objects/model/backbone/generator/flow_matching/model.py']
