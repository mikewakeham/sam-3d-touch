...
**Current work, 2026-09-14:** [camera-frame target latent experiment](scripts/camera_frame_target_latent/README.md): 16 objects, eight training and four held-out views each; no unseen objects, three matched arms, 1,000 updates at batch 4, loss validation every 100; reconstruction deferred until after training. Standalone interactive experiment, local JSON logs, one GPU per arm; optional experiment-local submission script; local logging without W&B. Three cluster runs are complete; [results](scripts/camera_frame_target_latent/RESULTS_20260914.md) show no clear shared-PM loss benefit. Final generated reconstruction remains unmeasured. Production code is unchanged.
