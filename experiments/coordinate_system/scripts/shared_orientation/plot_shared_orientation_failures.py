...
from experiments.coordinate_system.scripts.shared.pose_shape_geometry import points, subset
from experiments.coordinate_system.scripts.shared_orientation.shared_orientation_protocol import transform_points

HERE=Path(__file__).resolve().parent
out=_source_path(HERE, 'shared_orientation_geometry_analysis');root=out/'bundle'
