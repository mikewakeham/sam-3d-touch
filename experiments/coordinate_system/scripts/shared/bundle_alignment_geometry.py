...
from experiments.coordinate_system.scripts.alignment_robustness.analyze_alignment_tolerance import analyze
...
def collect(root, camera_dir=None, include_camera=True):
    ...
    if include_camera:
        ...
        reference = _source_path(HERE, 'multiple_view_returned_46083371/camera.json')
