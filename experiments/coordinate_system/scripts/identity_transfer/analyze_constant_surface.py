...
from experiments.coordinate_system.scripts.identity_transfer.analyze_object_transfer import object_losses, validate
...
if __name__ == '__main__':
    ...
    for key in ('image', 'camera', 'oracle'):
        path = _source_path(HERE, 'object_transfer_returned_manual')/key/'results.json'
