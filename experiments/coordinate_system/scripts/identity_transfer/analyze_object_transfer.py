...
if __name__ == '__main__':
    ...
    for key in MODEL_KEYS:
        ...
        assert reports[key]['plan_sha256'] == sha(_source_path(HERE, 'object_transfer_plan.json'))
        assert reports[key]['reference_sha256'] == sha(_source_path(HERE, 'tiny_fit_returned_46083371/oracle/results.json'))
